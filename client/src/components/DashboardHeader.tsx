import { BookOpen, Edit3, LogOut, Plus, Settings } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import type { User } from '../types';

interface DashboardHeaderProps {
  user: User | null;
  onShowPrefsModal: () => void;
  onLogout: () => Promise<void>;
}

const DashboardHeader: React.FC<DashboardHeaderProps> = ({ user, onShowPrefsModal, onLogout }) => {
